"""
Unit tests for the pure view-ordering helpers. Postgres cannot create a view cycle or be
coerced into some edge shapes, so these branches are exercised directly rather than through
a live database.
"""
