...
async def test_schema_create(gen_setup: GenerateSetup) -> None:
    """
...
async def test_schema_drop(gen_setup: GenerateSetup) -> None:
    """
...
async def test_schema_comment_added(gen_setup: GenerateSetup) -> None:
    """
