...
async def test_owned_sequence_on_non_integer_column_is_unsupported(gen_setup: GenerateSetup) -> None:
    """
...
async def test_serial_column_with_primary_key_and_other_column(gen_setup: GenerateSetup) -> None:
    """
...
async def test_identity_by_default_column_emitted(gen_setup: GenerateSetup) -> None:
    """
...
async def test_identity_always_column_emitted(gen_setup: GenerateSetup) -> None:
    """
...
async def test_identity_column_added_to_existing_table(gen_setup: GenerateSetup) -> None:
    """
...
async def test_serial_change_in_alter_path_raises(gen_setup: GenerateSetup) -> None:
    """
