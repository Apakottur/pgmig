...
async def test_table_create(gen_setup: GenerateSetup) -> None:
    """
...
async def test_table_create_with_quote_in_name(gen_setup: GenerateSetup) -> None:
    """
...
async def test_table_drop(gen_setup: GenerateSetup) -> None:
    """
