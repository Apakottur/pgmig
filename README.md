...
| `--driver`               | `driver`             | Database driver to connect with: `auto` (default), `psycopg` or `asyncpg`. `auto` picks among the installed drivers; naming one pins it. See [the FAQ](#which-driver-should-i-install). |
